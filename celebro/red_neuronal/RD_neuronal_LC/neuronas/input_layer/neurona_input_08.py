"""
Neurona de Entrada 08 - Módulo Independiente
===========================================

Octava neurona de la capa de entrada de la red neuronal modular.
...
class NeuronaInput08Config(NeuronConfig):
    """Configuración específica para la neurona de entrada 08"""
...
class NeuronaInput08(InputNeuron):
    """Neurona de entrada 08 - Procesa la octava característica de entrada."""
    
    def __init__(self):
        config = NeuronaInput08Config()
        ...
        logger.info(f"Neurona de entrada 08 inicializada - ID: {self.config.neuron_id}")
...
async def main():
    print("=" * 60)
    print("NEURONA DE ENTRADA 08 - MÓDULO INDEPENDIENTE")
    print("=" * 60)
    
    try:
        neurona = NeuronaInput08()
        ...
        test_data = [1.1, -0.4, 0.6, 0.8, -1.2, 0.3, -0.7, 1.0]
        ...
        print("\n✅ NEURONA DE ENTRADA 08 COMPLETADA EXITOSAMENTE")
        
    except Exception as e:
        print(f"❌ Error en neurona de entrada 08: {e}")
