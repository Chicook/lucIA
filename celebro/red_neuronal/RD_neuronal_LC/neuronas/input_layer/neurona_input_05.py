"""
Neurona de Entrada 05 - Módulo Independiente
===========================================

Quinta neurona de la capa de entrada de la red neuronal modular.
...
class NeuronaInput05Config(NeuronConfig):
    """Configuración específica para la neurona de entrada 05"""
...
class NeuronaInput05(InputNeuron):
    """Neurona de entrada 05 - Procesa la quinta característica de entrada."""
    
    def __init__(self):
        config = NeuronaInput05Config()
        ...
        logger.info(f"Neurona de entrada 05 inicializada - ID: {self.config.neuron_id}")
...
async def main():
    print("=" * 60)
    print("NEURONA DE ENTRADA 05 - MÓDULO INDEPENDIENTE")
    print("=" * 60)
    
    try:
        neurona = NeuronaInput05()
        ...
        test_data = [0.8, -0.5, 1.2, 0.3, -0.9, 0.6, -0.1, 1.1]
        ...
        print("\n✅ NEURONA DE ENTRADA 05 COMPLETADA EXITOSAMENTE")
        
    except Exception as e:
        print(f"❌ Error en neurona de entrada 05: {e}")
