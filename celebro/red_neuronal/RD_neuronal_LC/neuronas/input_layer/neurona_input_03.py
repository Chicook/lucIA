"""
Neurona de Entrada 03 - Módulo Independiente
===========================================

Tercera neurona de la capa de entrada de la red neuronal modular.
...
class NeuronaInput03Config(NeuronConfig):
    """Configuración específica para la neurona de entrada 03"""
...
class NeuronaInput03(InputNeuron):
    """Neurona de entrada 03 - Procesa la tercera característica de entrada."""
    
    def __init__(self):
        config = NeuronaInput03Config()
        ...
        logger.info(f"Neurona de entrada 03 inicializada - ID: {self.config.neuron_id}")
...
async def main():
    print("=" * 60)
    print("NEURONA DE ENTRADA 03 - MÓDULO INDEPENDIENTE")
    print("=" * 60)
    
    try:
        neurona = NeuronaInput03()
        ...
        test_data = [0.7, -0.4, 1.1, 0.2, -0.9, 1.6, -0.3, 0.8]
        ...
        print("\n✅ NEURONA DE ENTRADA 03 COMPLETADA EXITOSAMENTE")
        
    except Exception as e:
        print(f"❌ Error en neurona de entrada 03: {e}")
